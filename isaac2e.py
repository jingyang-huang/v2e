...
def main():
    ...
    # Visualization
    mt_image_rate = args.mt_image_rate
   ...
   # input file checking
    ...
    if not synthetic_input:
        ...
        if exposure_mode == ExposureMode.DURATION:
            ...
            dvsMtImageDuration = dvsNumFrames/mt_image_rate
            start_time = start_frame/srcFps
